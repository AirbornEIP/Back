...
async function AddPlane(req: any, res: express.Response) {
    try {
...
async function getAllPlane(req: any, res: express.Response) {
    try {
...
async function removePlane(req: any, res: express.Response) {
    try {
...
async function getPlane(req: any, res: express.Response) {
    try {
